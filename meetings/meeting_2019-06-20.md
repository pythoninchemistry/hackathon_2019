...
- The proposal was funded by the RSC panel to the amount of £300, however the panel had some [questions](../questions.md). In particular, how would we continue to fund this endeavour was one that we didn't yet have an answer for.
    ...
    - The Bristol Institute of Learning and Teaching should be a useful source of future funding (http://www.bristol.ac.uk/bilt/general-and-information/funding-opportunities/). 
...
- We naturally entered into a conversation of things that we could work on during the hackathon (lots of ideas were suggeted)
    ...
    - NF agreed to share Chloe's project report after marking finished. (https://gke.mybinder.org/v2/gh/Clohastings/projectpython/master, report to follow)
...
- NF to share Chloe's project report once the marking is complete. (https://gke.mybinder.org/v2/gh/Clohastings/projectpython/master, report to come)
